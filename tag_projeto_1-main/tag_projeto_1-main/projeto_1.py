...
import visualizacao_grafo
import coeficiente_de_aglomeracao
...
def exibir_grau(lista_adjacencia):
    print("Lista de vértices e graus:")
...
def main():
    ...
    #Exibir os coeficientes de aglomeração dos vértices
    print("\nCoeficientes de aglomeração dos vértices:")
    for vertice in lista_adjacencia:
        cof_agl = coeficiente_de_aglomeracao.coeficiente_de_aglomeracao(lista_adjacencia, vertice)
        print(f"Vértice {vertice}: Coeficiente de Aglomeração {cof_agl}")

    #Exibir o coeficiente médio de aglomeração do grafo
    cof_agl_medio = coeficiente_de_aglomeracao.coeficiente_medio_de_aglomeracao(lista_adjacencia)
    print(f"\nCoeficiente médio de Aglomeração do Grafo: {cof_agl_medio}")

    #Gerar a visualização do grafo, destacando os cliques maximais por cores
    visualizacao_grafo.visualizar_cliques(lista_adjacencia, cliques_maximais)
